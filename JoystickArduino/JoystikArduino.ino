...
void checkJoy() {
  ...
  bool currRead_W = false;
  bool currRead_A = false;
  bool currRead_S = false;
  bool currRead_D = false;
  int xValue = analogRead(PIN_W);

  int yValue = analogRead(PIN_A);
   if (xValue > 700) {
      //Serial.print("UP");
      currRead_W = true;
    } else if (xValue < 300) {
